...
echo ""
echo "⏰ PRÓXIMOS PASOS:"
echo "   1. 🚨 PROBLEMA CONFIRMADO: GitHub Actions falla por token inválido"
echo "   2. Error específico: 'No matching Static Web App was found or the api key was invalid'"
echo "   3. SOLUCIÓN: Ejecutar ./fix-swa-token.sh para obtener el token correcto"
echo "   4. Actualizar secreto en GitHub: Settings > Secrets > AZURE_STATIC_WEB_APPS_API_TOKEN"
echo "   5. O deployment manual: cd frontend && npx @azure/static-web-apps-cli deploy out --deployment-token TOKEN"
echo ""
